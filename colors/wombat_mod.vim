...
hi helpHyperTextJump guifg=#d47f7f guibg=NONE gui=NONE cterm=NONE
hi helpNotVi guifg=#777777 guibg=NONE gui=NONE cterm=NONE
hi helpOption guifg=#cae682 guibg=NONE gui=NONE cterm=NONE
...
hi helpHeadline guifg=#dddd77 guibg=NONE gui=NONE cterm=NONE
hi helpSectionDelim guifg=#ffffff guibg=NONE gui=NONE cterm=NONE
hi helpBar guifg=#444444 guibg=NONE gui=NONE cterm=NONE
hi helpStar guifg=#444444 guibg=NONE gui=NONE cterm=NONE
hi helpBacktick guifg=#444444 guibg=NONE gui=NONE cterm=NONE
...
hi vimBracket guifg=#5a9fbf guibg=NONE gui=NONE cterm=NONE
...
hi xmlTag guifg=#5a9fbf guibg=NONE gui=NONE cterm=NONE
hi xmlTagname guifg=#8ac6f2 guibg=NONE gui=NONE cterm=NONE
hi xmlAttrib guifg=#cae682 guibg=NONE gui=NONE cterm=NONE
hi xmlString guifg=#ffcc99 guibg=NONE gui=NONE cterm=NONE
hi htmlTag guifg=#5a9fbf guibg=NONE gui=NONE cterm=NONE
hi htmlEndTag guifg=#5a9fbf guibg=NONE gui=NONE cterm=NONE
hi htmlTagName guifg=#8ac6f2 guibg=NONE gui=NONE cterm=NONE
hi htmlArg guifg=#cae682 guibg=NONE gui=NONE cterm=NONE
hi htmlString guifg=#ffcc99 guibg=NONE gui=NONE cterm=NONE
hi htmlSpecialChar guifg=#b984b1 guibg=NONE gui=NONE cterm=NONE
hi shQuote guifg=#ffcc99 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi helpHyperTextJump ctermfg=174 ctermbg=NONE cterm=NONE
  hi helpNotVi ctermfg=243 ctermbg=NONE cterm=NONE
  hi helpOption ctermfg=192 ctermbg=NONE cterm=NONE
  ...
  hi helpHeadline ctermfg=185 ctermbg=NONE cterm=NONE
  hi helpSectionDelim ctermfg=231 ctermbg=NONE cterm=NONE
  hi helpBar ctermfg=238 ctermbg=NONE cterm=NONE
  hi helpStar ctermfg=238 ctermbg=NONE cterm=NONE
  hi helpBacktick ctermfg=238 ctermbg=NONE cterm=NONE
  ...
  hi vimBracket ctermfg=74 ctermbg=NONE cterm=NONE
  ...
  hi xmlTag ctermfg=74 ctermbg=NONE cterm=NONE
  hi xmlTagname ctermfg=111 ctermbg=NONE cterm=NONE
  hi xmlAttrib ctermfg=192 ctermbg=NONE cterm=NONE
  hi xmlString ctermfg=223 ctermbg=NONE cterm=NONE
  ...
  hi htmlArg ctermfg=192 ctermbg=NONE cterm=NONE
  hi htmlString ctermfg=223 ctermbg=NONE cterm=NONE
  hi htmlSpecialChar ctermfg=139 ctermbg=NONE cterm=NONE
  hi shQuote ctermfg=223 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 8
  ...
  hi helpHyperTextJump ctermfg=Red ctermbg=NONE cterm=NONE
  hi helpNotVi ctermfg=DarkGray ctermbg=NONE cterm=NONE
  hi helpOption ctermfg=Green ctermbg=NONE cterm=NONE
  ...
  hi helpHeadline ctermfg=Yellow ctermbg=NONE cterm=NONE
  hi helpSectionDelim ctermfg=White ctermbg=NONE cterm=NONE
  hi helpBar ctermfg=DarkGray ctermbg=NONE cterm=NONE
  hi helpStar ctermfg=DarkGray ctermbg=NONE cterm=NONE
  hi helpBacktick ctermfg=DarkGray ctermbg=NONE cterm=NONE
  ...
  hi vimBracket ctermfg=Blue ctermbg=NONE cterm=NONE
  ...
  hi xmlTag ctermfg=Blue ctermbg=NONE cterm=NONE
  hi xmlTagname ctermfg=Blue ctermbg=NONE cterm=NONE
  hi xmlAttrib ctermfg=Green ctermbg=NONE cterm=NONE
  hi xmlString ctermfg=DarkYellow ctermbg=NONE cterm=NONE
  hi htmlTag ctermfg=Blue ctermbg=NONE cterm=NONE
  hi htmlEndTag ctermfg=Blue ctermbg=NONE cterm=NONE
  hi htmlTagName ctermfg=Blue ctermbg=NONE cterm=NONE
  hi htmlArg ctermfg=Green ctermbg=NONE cterm=NONE
  hi htmlString ctermfg=DarkYellow ctermbg=NONE cterm=NONE
  hi htmlSpecialChar ctermfg=Magenta ctermbg=NONE cterm=NONE
  hi shQuote ctermfg=DarkYellow ctermbg=NONE cterm=NONE
